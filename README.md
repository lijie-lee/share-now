...
> Here are the instructions to run the sample in **Visual Studio Code**. You can also run the app using the TeamsFx CLI tool by following [Try the Sample with TeamsFx CLI](cli.md).
...
1. Open **env/.env.dev** file. You can get the database name from `PROVISIONOUTPUT__AZURESQLOUTPUT__DATABASENAME`. Then [add your computer's IP address to the server-level firewall rule from the database overview page](https://docs.microsoft.com/en-us/azure/azure-sql/database/firewall-configure#from-the-database-overview-page).
...
1. You can update content created by you by clicking "..." and then choosing "update".
1. You can delete content created by you by clicking "..." and then choosing "delete".
1. You can add or remove your vote for content by clicking the icon ![vote icon](images/voteIconME.png).
1. You can search all content or content posted by you in the compose box or command box by filtering on title or tags, and then share it with your colleagues.
