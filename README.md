...
- How to host a tab frontend on Azure.
- How to host a tab backend on Azure.
- How to host a message extension bot on Azure.
...
> Here are the instructions to run the sample in **Visual Studio Code**. You can also run the app by using TeamsFx CLI. See [Try the Sample with TeamsFx CLI](cli.md).
...
1. You can search all content or only your content in the compose box or command box by filtering on title or tags, then share with your colleagues.
